...
-----------------------------------------------------------------------------
        ...
        if player.drink == 1:
            print("""
-----------------------------------------------------------------------------
You drank the poisonous soup together and safely escaped from this place.
-----------------------------------------------------------------------------
            """)
            player.victory = True
            sys.exit()
            ...
            print("""
-----------------------------------------------------------------------------
You drank the poisonous soup alone and safely escaped from this place.
-----------------------------------------------------------------------------
                        """)
            player.victory = True
            sys.exit()
...
# if isinstance(room_map[1][1], StartRoom):
#     room_map[1][1].print_map()